...
IF(COVISE_USE_OPENCV5)
    set(MAJOR 5)
    set(SUFFIXES opencv5)
    SET(OPENCV_EXTERNLIBS $ENV{EXTERNLIBS}/opencv5)
...
IF(COVISE_USE_OPENCV5)
    ...
    # OpenCV5 on your distro uses "calib" instead of "calib3d"
    FIND_OPENCV_COMPONENT(calib 470)

    # map calib -> calib3d variables expected by the rest of COVISE
    if(NOT OPENCV_CALIB3D_FOUND AND OPENCV_CALIB_FOUND)
        set(OPENCV_CALIB3D_FOUND TRUE)
        set(OPENCV_CALIB3D_LIBRARY "${OPENCV_CALIB_LIBRARY}" CACHE FILEPATH "OPENCV - Library" FORCE)
    endif()

    # OpenCV5 may not ship a separate libopencv_aruco
    if(NOT OPENCV_ARUCO_FOUND AND OPENCV_OBJDETECT_FOUND)
        set(OPENCV_ARUCO_FOUND TRUE)
        set(OPENCV_ARUCO_LIBRARY "${OPENCV_OBJDETECT_LIBRARY}" CACHE FILEPATH "OPENCV - Library" FORCE)
    endif()
