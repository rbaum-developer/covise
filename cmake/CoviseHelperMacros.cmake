...
MACRO(CREATE_USING)
  ...
  FILE(APPEND ${filename} "  SET(using_found FALSE)\n")
  ...
  FOREACH(ctr RANGE ${using_list_size})
    ...
    FILE(APPEND ${filename} "      SET(using_found TRUE)\n")
  ...
  FILE(APPEND ${filename} "  if(NOT \$\{using_found\})\n")
  FILE(APPEND ${filename} "     message(SEND_ERROR \"USING: did not find \$\{ARGV\}\")\n")
  #FILE(APPEND ${filename} "  else()\n")
  #FILE(APPEND ${filename} "     message(\"USING: \$\{ARGV\}\")\n")
...
MACRO(COVISE_FIND_PACKAGE package)
   ...
   if (APPLE)
       ...
       if (pack STREQUAL "OpenCV")
           if (COVISE_USE_OPENCV5)
               set(hbpack "opencv@5")
           elseif (COVISE_USE_OPENCV4)
               set(hbpack "opencv@4")
   ...
   if (NOT COVISE_ARCHSUFFIX MATCHES "^spack")
       if (pack STREQUAL "OpenCV")
           if (COVISE_USE_OPENCV5)
                set(pack "OpenCV5")
           elseif (COVISE_USE_OPENCV4)
